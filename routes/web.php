...
Route::group(['middleware' => ['auth:web', 'verified']], function () {
    ...
    Route::get('/admin/datagajipegawai/excel', [TambahanController::class, 'excel'])->name('gajipegawai.excel');
    Route::get('/admin/datagajipegawai/cetakperid/{id}', [admingajipegawaicontroller::class, 'cetakperid'])->name('gajipegawai.cetakperid');
    Route::get('/admin/datagajipegawai/absen/{id}', [admingajipegawaicontroller::class, 'absen'])->name('gajipegawai.absen');
    Route::get('/admin/datagajipegawai/potongan/{id}', [admingajipegawaicontroller::class, 'potongan'])->name('gajipegawai.potongan');
    Route::put('/admin/datagajipegawai/potongan/{id}', [admingajipegawaicontroller::class, 'potupdate'])->name('gajipegawai.potupdate');
    Route::put('/admin/datagajipegawai/absen/{id}', [admingajipegawaicontroller::class, 'absenupdate'])->name('gajipegawai.absenupdate');
